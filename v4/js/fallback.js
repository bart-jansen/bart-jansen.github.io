/**
 * Fills the plain-HTML fallback from the same content module the island uses,
 * so the no-WebGL version is never a stub. It runs on every load and costs
 * nothing visible when the island starts.
 */
